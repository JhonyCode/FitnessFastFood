...
class CategoriaController extends AbstractController
{
     ...
     */
    public function index(PublicacionesRepository $publicacionesRepository, CategoriaRepository $categoriaRepository): Response
    {
        $categorium = $categoriaRepository->findAll();
        $resultado = [];
        foreach ($categorium as $c) {
            $publicaciones = $publicacionesRepository->findBy(['categoria' => $c->getId()]);
            $resultado1 = [];
